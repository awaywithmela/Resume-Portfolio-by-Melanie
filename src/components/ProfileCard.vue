...
<template>
  <BorderGlow className="w-full rounded-3xl overflow-hidden relative">
      ...
      <div class="flex flex-col gap-8 md:flex-row md:items-center">
        ...
        <div class="flex-1 space-y-4">
          ...
          <div class="pt-4">
            ...
            >
              <div class="flex items-center gap-2 px-4 py-2 text-purple-400 font-bold hover:text-white transition-all duration-300">
