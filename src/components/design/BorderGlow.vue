<template>
  <div
    ...
    :class="[
      'border-glow-card',
      backgroundColor !== '#ffffff' && backgroundColor !== '#fff' ? 'dark-glow-card' : 'light-glow-card',
      className
    ]"
    :style="styleObject"
  >
...
const styleObject = computed(() => {
  const glowVars = buildGlowVars(props.glowColor, props.glowIntensity);
  const gradVars = buildGradientVars(props.colors);
  return {
